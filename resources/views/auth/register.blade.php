                ...
                <div class="wsus__sign_form_area">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link {{ Session::has('frontend_register_list_style') && Session::get('frontend_register_list_style') == 'student' ? 'active' : '' }} {{ !Session::has('frontend_register_list_style') ? 'active' : '' }} list-view"
                                data-id="student" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                                type="button" role="tab" aria-controls="pills-home"
                                aria-selected="true">Student</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link {{ Session::has('frontend_register_list_style') && Session::get('frontend_register_list_style') == 'instructor' ? 'active' : '' }} list-view"
                                data-id="instructor" id="pills-profile-tab" data-bs-toggle="pill"
    ...
    <script>
        $(document).ready(function() {
            $('.list-view').on('click', function() {
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ route('frontend-register-list-style') }}",
                    data: {
                        style: style
                    },
