            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Update Course Category</h4>
                        <div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="show_at_treading"
                                    ...
                                    <option @selected($category->show_at_trending === 1) value="1">Yes</option>
                                    <option @selected($category->show_at_trending === 0) value="0">No</option>
                                </select>
